...
const Deposite = () => {
  ...
  const filterTransaction = showTransactionData.filter(
    (type) => type.transactionTypes === "Deposite"
  );

   // const totalDeposite = filterTransaction.reduce((acc, transfer) => {
      ...
      {filterTransaction.length > 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex md:justify-between md:items-center mb-2 mt-2 xs:justify-start xs:items-start xs:gap-2  xs:flex-col md:flex-row">
                      <h1 className="text-blue-500 text-[1.2rem] flex items-center  gap-2 font-bold">
                        <span>
                          <FaArrowUp className="text-blue-500" />
                        </span>{" "}
                        {transactionTypes}
                      </h1>
                      <h1 className="text-blue-500 text-[1.2rem] font-bold">
                        {currency} {amount}
                      </h1>
                    </div>
        ...
        <div className="flex flex-col items-center gap-6 justify-between mt-10">
          ...
          <Link to="/transaction-form">
            <button className="px-4 py-2 rounded bg-blue-500 text-whitehover:bg-transparent border-none outline-none hover:outline-2 hover:outline-blue-500">
